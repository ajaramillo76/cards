...
/**
 * Encapsulates the suits of standard playing cards. The enum includes {@link #symbol()} and {@link #color()}, to return the immutable Unicode symbol and {@link Color} enum instance of any suit.
 */
public enum Suit {
  CLUBS, DIAMONDS, HEARTS, SPADES;

  private static final String[] symbols = {"\u2663", "\u2662", "\u2661", "\u2660"}; // unicode code points
